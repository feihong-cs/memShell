    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try{
            ...
            for(NamedObject namedObject : namedObjectSet){
                ...
                if(!flag){
                    System.out.println("[+] 添加动态 Servlet");
                    ...
                    Servlet servlet = new HttpServlet() {
                        ...
                        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
                            System.out.println("Hello, I'm jetty dynamic servlet!");
...
//                    ServletHolder.this.getServletHandler().addServletMapping(mappingx);
                    ...
                    servletMapping.getClass().getMethod("setPathSpecs", String[].class).invoke(servletMapping, new Object[]{new String[]{"/yyy"}});
